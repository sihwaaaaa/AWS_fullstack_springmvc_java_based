                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <a href="register${page.cri.queryString}" class="btn btn-primary float-right btn-small">Register New Board</a>
                        </div>
                        <div class="card-body">
                        	...
                        	<form class="justify-content-center d-flex mb-3">
                        		...
                        		<select class="form-control-sm mr-3" name="type">
		                            ...
		                            <input name="keyword" type="text" value="${page.cri.keyword}" class="form-control-sm bg-light border-0 small w-50" placeholder="Search for..."
...
<script>
	...
	$(function () {
		...
		if(result !== 'success'){
			$("#myModal .modal-body").html("게시글" + result + "번이 등록 되었습니다")
		}
		$("#myModal").modal("show");
