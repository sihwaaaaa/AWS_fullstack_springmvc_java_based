...
import co.poetrypainting.mapper.CrawlMapper;
...
public class CGVParserTests {
	...
	public void parse() throws MalformedURLException, IOException{
		Document doc = Jsoup.parse(new URL("https://www.cgv.co.kr/movies/"),2000);
	...
	@Test
	public void testDownloadThumbs() throws Exception{
//		InputStream is = new URL("http://www.w3.org/2000/svg").openStream();
//		FileUtils.copyInputStreamToFile(is, new File("d:/tmp.png"));
	...
	public void testInsertPerson(){
		...
		map.put("pidx", "1978");
		map.put("name", "벤 애플렉");
		map.put("href","/movies/person/?pidx=1978" );
//		map.put("pidx", "734");
//		map.put("name", "휴고 위빙");
...
//			}
	...
	public void testDownloadStillCut() throws MalformedURLException, IOException{
		...
		for (Map<String, Object> m : list) {
			String url = "http://www.cgv.co.kr/" + m.get("href");
			Document doc = Jsoup.connect(url).get();//(new URL(url),2000);
